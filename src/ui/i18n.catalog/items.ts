...
const ITEM_ENTITY_IDS = [
  ...
  "bogiron_nugget", "soggy_moccasin", "cracked_fetish", "chipped_tusk", "deepfen_pearl", "highwatch_summons", "ridge_stalker_pelt", "pristine_ridge_stalker_pelt",
...
const itemNamesEn = {
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      "Soggy Moccasin", "Cracked Fetish", "Chipped Tusk", "Deepfen Pearl", "Highwatch Summons", "Ridge Stalker Pelt", "Pristine Ridge Stalker Pelt", "Glowing Wax", "Ogre War Totem", "Storm Core",
  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Mocasín empapado", "Fetiche agrietado", "Colmillo astillado", "Perla de Deepfen", "Citación de Highwatch", "Piel de acechador de la cresta", "Piel prístina de acechador de la cresta", "Cera resplandeciente", "Tótem de guerra ogro", "Núcleo de tormenta",
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Mocassin détrempé", "Fétiche fissuré", "Défense ébréchée", "Perle de Deepfen", "Convocation de Highwatch", "Peau de rôdeur de la crête", "Peau immaculée de rôdeur de la crête", "Cire luisante", "Totem de guerre ogre", "Noyau de tempête",
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Mocassino fradicio", "Feticcio incrinato", "Zanna scheggiata", "Perla di Deepfen", "Convocazione di Highwatch", "Pelliccia di predatore del crinale", "Pelliccia immacolata di predatore del crinale", "Cera luminosa", "Totem da guerra ogre", "Nucleo di tempesta",
  ...
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Durchnässter Mokassin", "Rissiger Fetisch", "Angeschlagener Hauer", "Deepfen-Perle", "Einberufung von Highwatch", "Balg eines Gratpirschers", "Makelloser Balg eines Gratpirschers", "Glühendes Wachs", "Ogerkriegstotem", "Sturmkern",
  ...
  zh_CN: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "湿透的软鞋", "裂纹护符", "缺口獠牙", "深沼珍珠", "高望召令", "山脊潜伏者毛皮", "无瑕的山脊潜伏者毛皮", "发光蜡块", "食人魔战争图腾", "风暴核心",
  ...
  zh_TW: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "濕透的軟鞋", "裂紋護符", "缺口獠牙", "深沼珍珠", "高望召令", "山脊潛伏者毛皮", "無瑕的山脊潛伏者毛皮", "發光蠟塊", "巨魔戰爭圖騰", "風暴核心",
  ...
  ko_KR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "젖은 모카신", "금 간 부적", "이 빠진 엄니", "딥펜 진주", "하이워치 소환장", "산등성이 추적자 가죽", "온전한 산등성이 추적자 가죽", "빛나는 밀랍", "오우거 전쟁 토템", "폭풍 핵",
  ...
  ja_JP: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "水浸しのモカシン", "ひび割れた護符", "欠けた牙", "ディープフェンの真珠", "ハイウォッチ召喚状", "尾根の追跡者の毛皮", "極上の尾根の追跡者の毛皮", "光る蝋", "オーガ戦のトーテム", "嵐の核",
  ...
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Mocassim encharcado", "Fetiche rachado", "Presa lascada", "Pérola de Deepfen", "Convocação de Highwatch", "Pele de espreitador da crista", "Pele imaculada de espreitador da crista", "Cera brilhante", "Totem de guerra ogro", "Núcleo da tempestade",
  ...
  ru_RU: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Промокший мокасин", "Треснувший фетиш", "Щербатый клык", "Жемчужина Глубокой Топи", "Призыв Хайвотча", "Шкура хребтового охотника", "Безупречная шкура хребтового охотника", "Светящийся воск", "Боевой тотем огра", "Ядро бури",
